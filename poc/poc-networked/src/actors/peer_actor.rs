...
impl PeerActor {
    ...
    async fn own_peer_id(&self) -> NetworkedResult<PeerId> {
        self.niso.call(|entity| entity.get_peer_id().or_err()).await
    }

    async fn own_wt_peer_id(&self) -> NetworkedResult<WtPeerId> {
        self.niso
            .call(|entity| entity.get_wt_peer_id().or_err())
            .await
    }
    ...
    async fn send_to_wt(&self, envelope: PeerToWtEnvelope) -> NetworkedResult<()> {
        self.peer_to_wt_tx.send(envelope).await.or_err()?;
        Ok(())
    }

    async fn recv_from_wt(&mut self) -> NetworkedResult<WtToPeerEnvelope> {
        self.wt_to_peer_rx.recv().await.or_err()
    }

    async fn send_to_sar(&self, envelope: PeerToSarEnvelope) -> NetworkedResult<()> {
        self.peer_to_sar_tx.send(envelope).await.or_err()?;
        Ok(())
    }

    async fn recv_from_sar(&mut self) -> NetworkedResult<SarToPeerEnvelope> {
        self.sar_to_peer_rx.recv().await.or_err()
    }

    async fn register_in_peer_directory(&self) -> NetworkedResult<()> {
    ...
    async fn broadcast_out_of_band_message(
        &self,
    ...
    async fn recv_merged_out_of_band_message(
        &mut self,
    ) -> NetworkedResult<SetupUserPeersOutOfBandMessage1> {
        let mut received = Vec::with_capacity(self.other_peer_count());
        let mut senders = BTreeSet::new();
        while received.len() < self.other_peer_count() {
            match self.peer_to_peer_rx.recv().await.or_err()? {
                PeerToPeerEnvelope::SetupUserPeersOutOfBandMessage1 {
                    sender_peer_id,
                    msg,
                } => {
                    if !senders.insert(sender_peer_id) {
                        return unexpected("PeerActor: duplicate out-of-band sender");
                    }
                    received.push(msg);
                }
                _ => {
                    return unexpected(
                        "PeerActor: unexpected peer envelope during out-of-band exchange",
                    );
                }
            }
        }
        ...
        let mut merged = iter.next().or_err()?;
        merged.merge(iter.collect());
        Ok(merged)
    }

    async fn send_peer_parcel<M, F>(
        &self,
    ...
    async fn recv_peer_parcel<M, F>(&mut self, unwrap: F) -> NetworkedResult<Parcel<PeerId, M>>
    where
        M: Message,
        F: Fn(PeerToPeerEnvelope) -> Option<(PeerId, M)>,
    {
        ...
        while messages.len() < self.other_peer_count() {
            let envelope = self.peer_to_peer_rx.recv().await.or_err()?;
            let (sender_peer_id, message) = unwrap(envelope).or_err()?;
            messages.push(MetadataAttachedMessage::new(sender_peer_id, message));
        }

        Ok(Parcel::new(messages))
    }

    async fn run_setup(&mut self) -> NetworkedResult<()> {
        let peer_number = self.peer_number();
        self.log_setup_step("starting phone and SAR handshake");

        let setup_phone_input_1 = self
            .peer
            .call(|entity| entity.produce_setup_phone_input_1().or_err())
            .await?;
        self.phone
            .call(|entity| {
                entity
        ...
        let setup_phone_sar_message_1 = self
            .phone
            .call(|entity| entity.produce_setup_phone_sar_message_1().or_err())
            .await?
        ...
        let setup_sar_phone_message_1 = match self.recv_from_sar().await? {
            ...
            _ => return unexpected("PeerActor: expected SetupSarPhoneMessage1"),
        };
        ...
        let setup_phone_output_1 = self
            .phone
            .call(|entity| entity.produce_setup_phone_output_1().or_err())
            .await?;
        self.peer
            .call(|entity| {
                entity
        ...
        let setup_phone_input_2 = self
            .peer
            .call(|entity| entity.produce_setup_phone_input_2().or_err())
            .await?;
        self.phone
            .call(|entity| {
                entity
        ...
        let setup_phone_sar_message_2 = self
            .phone
            .call(|entity| entity.produce_setup_phone_sar_message_2().or_err())
            .await?
            .look_for_message(&self.sar_id)
            .or_err()?
            .clone();
        ...
        let setup_sar_phone_message_2 = match self.recv_from_sar().await? {
            ...
            _ => return unexpected("PeerActor: expected SetupSarPhoneMessage2"),
        };
        ...
        let setup_phone_output_2 = self
            .phone
            .call(|entity| entity.produce_setup_phone_output_2().or_err())
            .await?;
        self.peer
            .call(|entity| {
                entity
        ...
        let setup_iso_input_1 = self
            .peer
            .call(|entity| entity.produce_setup_iso_input_1().or_err())
            .await?;
        self.iso
            .call(|entity| entity.consume_setup_iso_input_1(setup_iso_input_1).or_err())
            .await?;
        let setup_iso_boomlet_message_1 = self
            .iso
            .call(|entity| entity.produce_setup_iso_boomlet_message_1().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let setup_boomlet_iso_message_1 = self
            .boomlet
            .call(|entity| entity.produce_setup_boomlet_iso_message_1().or_err())
            .await?;
        self.iso
            .call(|entity| {
                entity
        ...
        let setup_iso_st_message_1 = self
            .iso
            .call(|entity| entity.produce_setup_iso_st_message_1().or_err())
            .await?;
        self.st
            .call(|entity| {
                entity
        ...
        let setup_st_iso_message_1 = self
            .st
            .call(|entity| entity.produce_setup_st_iso_message_1().or_err())
            .await?;
        self.iso
            .call(|entity| {
                entity
        ...
        let setup_iso_boomlet_message_2 = self
            .iso
            .call(|entity| entity.produce_setup_iso_boomlet_message_2().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let setup_boomlet_iso_message_2 = self
            .boomlet
            .call(|entity| entity.produce_setup_boomlet_iso_message_2().or_err())
            .await?;
        self.iso
            .call(|entity| {
                entity
        ...
        let setup_iso_st_message_2 = self
            .iso
            .call(|entity| entity.produce_setup_iso_st_message_2().or_err())
            .await?;
        self.st
            .call(|entity| {
                entity
        ...
        let setup_st_output_1 = self
            .st
            .call(|entity| entity.produce_setup_st_output_1().or_err())
            .await?;
        self.peer
            .call(|entity| entity.consume_setup_st_output_1(setup_st_output_1).or_err())
            .await?;
        let setup_st_input_1 = self
            .peer
            .call(|entity| entity.produce_setup_st_input_1().or_err())
            .await?;
        self.st
            .call(|entity| entity.consume_setup_st_input_1(setup_st_input_1).or_err())
            .await?;
        let setup_st_iso_message_2 = self
            .st
            .call(|entity| entity.produce_setup_st_iso_message_2().or_err())
            .await?;
        self.iso
            .call(|entity| {
                entity
        ...
        let setup_iso_boomlet_message_3 = self
            .iso
            .call(|entity| entity.produce_setup_iso_boomlet_message_3().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let setup_boomlet_iso_message_3 = self
            .boomlet
            .call(|entity| entity.produce_setup_boomlet_iso_message_3().or_err())
            .await?;
        self.iso
            .call(|entity| {
                entity
        ...
        let setup_iso_st_message_3 = self
            .iso
            .call(|entity| entity.produce_setup_iso_st_message_3().or_err())
            .await?;
        self.st
            .call(|entity| {
                entity
        ...
        let setup_st_output_2 = self
            .st
            .call(|entity| entity.produce_setup_st_output_2().or_err())
            .await?;
        self.peer
            .call(|entity| entity.consume_setup_st_output_2(setup_st_output_2).or_err())
            .await?;
        let setup_st_input_2 = self
            .peer
            .call(|entity| entity.produce_setup_st_input_2().or_err())
            .await?;
        self.st
            .call(|entity| entity.consume_setup_st_input_2(setup_st_input_2).or_err())
            .await?;
        let setup_st_iso_message_3 = self
            .st
            .call(|entity| entity.produce_setup_st_iso_message_3().or_err())
            .await?;
        self.iso
            .call(|entity| {
                entity
        ...
        let setup_iso_boomlet_message_4 = self
            .iso
            .call(|entity| entity.produce_setup_iso_boomlet_message_4().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let setup_boomlet_iso_message_4 = self
            .boomlet
            .call(|entity| entity.produce_setup_boomlet_iso_message_4().or_err())
            .await?;
        self.iso
            .call(|entity| {
                entity
        ...
        let setup_iso_output_1 = self
            .iso
            .call(|entity| entity.produce_setup_iso_output_1().or_err())
            .await?;
        self.peer
            .call(|entity| {
                entity
        ...
        let setup_niso_input_1 = self
            .peer
            .call(|entity| entity.produce_setup_niso_input_1().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let setup_niso_boomlet_message_1 = self
            .niso
            .call(|entity| entity.produce_setup_niso_boomlet_message_1().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let setup_boomlet_niso_message_1 = self
            .boomlet
            .call(|entity| entity.produce_setup_boomlet_niso_message_1().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let setup_niso_st_message_1 = self
            .niso
            .call(|entity| entity.produce_setup_niso_st_message_1().or_err())
            .await?;
        self.st
            .call(|entity| {
                entity
        ...
        let setup_st_output_3 = self
            .st
            .call(|entity| entity.produce_setup_st_output_3().or_err())
            .await?;
        self.peer
            .call(|entity| entity.consume_setup_st_output_3(setup_st_output_3).or_err())
            .await?;
        ...
        let setup_niso_input_2 = self
            .peer
            .call(|entity| entity.produce_setup_niso_input_2().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let setup_niso_boomlet_message_2 = self
            .niso
            .call(|entity| entity.produce_setup_niso_boomlet_message_2().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let setup_boomlet_niso_message_2 = self
            .boomlet
            .call(|entity| entity.produce_setup_boomlet_niso_message_2().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let setup_niso_st_message_2 = self
            .niso
            .call(|entity| entity.produce_setup_niso_st_message_2().or_err())
            .await?;
        self.st
            .call(|entity| {
                entity
        ...
        let setup_st_output_4 = self
            .st
            .call(|entity| entity.produce_setup_st_output_4().or_err())
            .await?;
        self.peer
            .call(|entity| entity.consume_setup_st_output_4(setup_st_output_4).or_err())
            .await?;
        let setup_st_input_3 = self
            .peer
            .call(|entity| entity.produce_setup_st_input_3().or_err())
            .await?;
        self.st
            .call(|entity| entity.consume_setup_st_input_3(setup_st_input_3).or_err())
            .await?;
        let setup_st_niso_message_1 = self
            .st
            .call(|entity| entity.produce_setup_st_niso_message_1().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let setup_niso_boomlet_message_3 = self
            .niso
            .call(|entity| entity.produce_setup_niso_boomlet_message_3().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let setup_boomlet_niso_message_3 = self
            .boomlet
            .call(|entity| entity.produce_setup_boomlet_niso_message_3().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let setup_niso_peer_niso_message_1 = self
            .niso
            .call(|entity| entity.produce_setup_niso_peer_niso_message_1().or_err())
            .await?;
        ...
        let setup_niso_boomlet_message_4 = self
            .niso
            .call(|entity| entity.produce_setup_niso_boomlet_message_4().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let setup_boomlet_niso_message_4 = self
            .boomlet
            .call(|entity| entity.produce_setup_boomlet_niso_message_4().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let setup_niso_boomlet_message_5 = self
            .niso
            .call(|entity| entity.produce_setup_niso_boomlet_message_5().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let setup_boomlet_niso_message_5 = self
            .boomlet
            .call(|entity| entity.produce_setup_boomlet_niso_message_5().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let setup_niso_wt_message_1 = self
            .niso
            .call(|entity| entity.produce_setup_niso_wt_message_1().or_err())
            .await?;
        let own_peer_id = self.own_peer_id().await?;
        ...
        let setup_wt_niso_message_1 = match self.recv_from_wt().await? {
            ...
            _ => return unexpected("PeerActor: expected SetupWtNisoMessage1"),
        };
        self.niso
            .call(|entity| {
                entity
        ...
        let setup_niso_output_1 = self
            .niso
            .call(|entity| entity.produce_setup_niso_output_1().or_err())
            .await?;
        self.peer
            .call(|entity| {
                entity
        ...
        let setup_niso_input_3 = self
            .peer
            .call(|entity| entity.produce_setup_niso_input_3().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let setup_niso_wt_message_2 = self
            .niso
            .call(|entity| entity.produce_setup_niso_wt_message_2().or_err())
            .await?;
        ...
        let setup_wt_niso_message_2 = match self.recv_from_wt().await? {
            ...
            _ => return unexpected("PeerActor: expected SetupWtNisoMessage2"),
        };
        self.niso
            .call(|entity| {
                entity
        ...
        let setup_niso_boomlet_message_6 = self
            .niso
            .call(|entity| entity.produce_setup_niso_boomlet_message_6().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let setup_boomlet_niso_message_6 = self
            .boomlet
            .call(|entity| entity.produce_setup_boomlet_niso_message_6().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let setup_niso_peer_niso_message_2 = self
            .niso
            .call(|entity| entity.produce_setup_niso_peer_niso_message_2().or_err())
            .await?;
        ...
        let setup_niso_boomlet_message_7 = self
            .niso
            .call(|entity| entity.produce_setup_niso_boomlet_message_7().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let setup_boomlet_niso_message_7 = self
            .boomlet
            .call(|entity| entity.produce_setup_boomlet_niso_message_7().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let setup_niso_boomlet_message_8 = self
            .niso
            .call(|entity| entity.produce_setup_niso_boomlet_message_8().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let setup_boomlet_niso_message_8 = self
            .boomlet
            .call(|entity| entity.produce_setup_boomlet_niso_message_8().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let setup_niso_wt_message_3 = self
            .niso
            .call(|entity| entity.produce_setup_niso_wt_message_3().or_err())
            .await?;
        let own_wt_peer_id = self.own_wt_peer_id().await?;
        ...
        let setup_wt_niso_message_3 = match self.recv_from_wt().await? {
            ...
            _ => return unexpected("PeerActor: expected SetupWtNisoMessage3"),
        };
        self.niso
            .call(|entity| {
                entity
        ...
        let setup_niso_boomlet_message_9 = self
            .niso
            .call(|entity| entity.produce_setup_niso_boomlet_message_9().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let setup_boomlet_niso_message_9 = self
            .boomlet
            .call(|entity| entity.produce_setup_boomlet_niso_message_9().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let setup_niso_peer_niso_message_3 = self
            .niso
            .call(|entity| entity.produce_setup_niso_peer_niso_message_3().or_err())
            .await?;
        ...
        let setup_niso_boomlet_message_10 = self
            .niso
            .call(|entity| entity.produce_setup_niso_boomlet_message_10().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let setup_boomlet_niso_message_10 = self
            .boomlet
            .call(|entity| entity.produce_setup_boomlet_niso_message_10().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let setup_niso_output_2 = self
            .niso
            .call(|entity| entity.produce_setup_niso_output_2().or_err())
            .await?;
        self.peer
            .call(|entity| {
                entity
        ...
        let setup_iso_input_2 = self
            .peer
            .call(|entity| entity.produce_setup_iso_input_2().or_err())
            .await?;
        self.iso
            .call(|entity| entity.consume_setup_iso_input_2(setup_iso_input_2).or_err())
            .await?;
        let setup_iso_boomletwo_message_1 = self
            .iso
            .call(|entity| entity.produce_setup_iso_boomletwo_message_1().or_err())
            .await?;
        self.boomletwo
            .call(|entity| {
                entity
        ...
        let setup_boomletwo_iso_message_1 = self
            .boomletwo
            .call(|entity| entity.produce_setup_boomletwo_iso_message_1().or_err())
            .await?;
        self.iso
            .call(|entity| {
                entity
        ...
        let setup_iso_output_2 = self
            .iso
            .call(|entity| entity.produce_setup_iso_output_2().or_err())
            .await?;
        self.peer
            .call(|entity| {
                entity
        ...
        let setup_iso_input_3 = self
            .peer
            .call(|entity| entity.produce_setup_iso_input_3().or_err())
            .await?;
        self.iso
            .call(|entity| entity.consume_setup_iso_input_3(setup_iso_input_3).or_err())
            .await?;
        let setup_iso_boomlet_message_5 = self
            .iso
            .call(|entity| entity.produce_setup_iso_boomlet_message_5().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let setup_boomlet_iso_message_5 = self
            .boomlet
            .call(|entity| entity.produce_setup_boomlet_iso_message_5().or_err())
            .await?;
        self.iso
            .call(|entity| {
                entity
        ...
        let setup_iso_output_3 = self
            .iso
            .call(|entity| entity.produce_setup_iso_output_3().or_err())
            .await?;
        self.peer
            .call(|entity| {
                entity
        ...
        let setup_iso_input_4 = self
            .peer
            .call(|entity| entity.produce_setup_iso_input_4().or_err())
            .await?;
        self.iso
            .call(|entity| entity.consume_setup_iso_input_4(setup_iso_input_4).or_err())
            .await?;
        let setup_iso_boomletwo_message_2 = self
            .iso
            .call(|entity| entity.produce_setup_iso_boomletwo_message_2().or_err())
            .await?;
        self.boomletwo
            .call(|entity| {
                entity
        ...
        let setup_boomletwo_iso_message_2 = self
            .boomletwo
            .call(|entity| entity.produce_setup_boomletwo_iso_message_2().or_err())
            .await?;
        self.iso
            .call(|entity| {
                entity
        ...
        let setup_iso_output_4 = self
            .iso
            .call(|entity| entity.produce_setup_iso_output_4().or_err())
            .await?;
        self.peer
            .call(|entity| {
                entity
        ...
        let setup_iso_input_5 = self
            .peer
            .call(|entity| entity.produce_setup_iso_input_5().or_err())
            .await?;
        self.iso
            .call(|entity| entity.consume_setup_iso_input_5(setup_iso_input_5).or_err())
            .await?;
        let setup_iso_boomlet_message_6 = self
            .iso
            .call(|entity| entity.produce_setup_iso_boomlet_message_6().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let setup_boomlet_iso_message_6 = self
            .boomlet
            .call(|entity| entity.produce_setup_boomlet_iso_message_6().or_err())
            .await?;
        self.iso
            .call(|entity| {
                entity
        ...
        let setup_iso_output_5 = self
            .iso
            .call(|entity| entity.produce_setup_iso_output_5().or_err())
            .await?;
        self.peer
            .call(|entity| {
                entity
        ...
        let setup_niso_input_4 = self
            .peer
            .call(|entity| entity.produce_setup_niso_input_4().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let setup_niso_boomlet_message_11 = self
            .niso
            .call(|entity| entity.produce_setup_niso_boomlet_message_11().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let setup_boomlet_niso_message_11 = self
            .boomlet
            .call(|entity| entity.produce_setup_boomlet_niso_message_11().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let setup_niso_peer_niso_message_4 = self
            .niso
            .call(|entity| entity.produce_setup_niso_peer_niso_message_4().or_err())
            .await?;
        ...
        let setup_niso_boomlet_message_12 = self
            .niso
            .call(|entity| entity.produce_setup_niso_boomlet_message_12().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let setup_boomlet_niso_message_12 = self
            .boomlet
            .call(|entity| entity.produce_setup_boomlet_niso_message_12().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let setup_niso_output_3 = self
            .niso
            .call(|entity| entity.produce_setup_niso_output_3().or_err())
            .await?;
        self.peer
            .call(|entity| {
                entity
    ...
    async fn run_withdrawal(&mut self) -> NetworkedResult<()> {
        let peer_number = self.peer_number();
        ...
        if self.initiator_runtime.is_some() {
            ...
            let initiator_reply = match self.recv_from_wt().await? {
                ...
                _ => return unexpected("PeerActor: expected WithdrawalWtNisoMessage1"),
            };
            self.handle_initiator_tx_aggregation(initiator_reply)
                .await?;
        } else {
            ...
            let approval_message = match self.recv_from_wt().await? {
                ...
                _ => return unexpected("PeerActor: expected WithdrawalWtNonInitiatorNisoMessage1"),
            };
            ...
            let ack_message = match self.recv_from_wt().await? {
                ...
                _ => return unexpected("PeerActor: expected WithdrawalWtNonInitiatorNisoMessage2"),
            };
            ...
            let commit_message = match self.recv_from_wt().await? {
                ...
                _ => return unexpected("PeerActor: expected WithdrawalWtNonInitiatorNisoMessage3"),
            };
            self.handle_non_initiator_commit_phase(commit_message)
                .await?;
        }

        let common_commit_message = match self.recv_from_wt().await? {
            WtToPeerEnvelope::WithdrawalWtNisoMessage2(msg) => msg,
            _ => return unexpected("PeerActor: expected WithdrawalWtNisoMessage2"),
        };
    ...
    async fn start_initiator_withdrawal(
        &mut self,
    ) -> NetworkedResult<JoinHandle<NetworkedResult<()>>> {
        let bitcoin_node = self.initiator_runtime.as_ref().or_err()?;
        ...
        let task_miner =
            Client::new(&rpc_address.to_string(), Auth::CookieFile(cookie_path)).or_err()?;
        ...
        let destination_address = Address::p2wpkh(
            &destination_pubkey.try_into().or_err()?,
            self.boomerang_config.network,
        );
        let boomerang_params = self
            .niso
            .call(|entity| entity.get_boomerang_params().or_err())
            .await?;
        let descriptor =
        ...
        loop {
            if miner.get_block_count().or_err()?
                >= self
                    .withdrawal_config
        ...
        let withdrawal_niso_boomlet_message_1 = self
            .niso
            .call(|entity| entity.produce_withdrawal_niso_boomlet_message_1().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let withdrawal_boomlet_niso_message_1 = self
            .boomlet
            .call(|entity| entity.produce_withdrawal_boomlet_niso_message_1().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let withdrawal_niso_st_message_1 = self
            .niso
            .call(|entity| entity.produce_withdrawal_niso_st_message_1().or_err())
            .await?;
        self.st
            .call(|entity| {
                entity
        ...
        let withdrawal_st_output_1 = self
            .st
            .call(|entity| entity.produce_withdrawal_st_output_1().or_err())
            .await?;
        self.peer
            .call(|entity| {
                entity
        ...
        let withdrawal_st_input_1 = self
            .peer
            .call(|entity| entity.produce_withdrawal_st_input_1().or_err())
            .await?;
        self.st
            .call(|entity| {
                entity
        ...
        let withdrawal_st_niso_message_1 = self
            .st
            .call(|entity| entity.produce_withdrawal_st_niso_message_1().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let withdrawal_niso_boomlet_message_2 = self
            .niso
            .call(|entity| entity.produce_withdrawal_niso_boomlet_message_2().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let withdrawal_boomlet_niso_message_2 = self
            .boomlet
            .call(|entity| entity.produce_withdrawal_boomlet_niso_message_2().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let withdrawal_niso_wt_message_1 = self
            .niso
            .call(|entity| entity.produce_withdrawal_niso_wt_message_1().or_err())
            .await?;
    ...
    async fn handle_initiator_tx_aggregation(
        &mut self,
        message: WithdrawalWtNisoMessage1,
    ) -> NetworkedResult<()> {
        self.niso
            .call(|entity| {
                entity
        ...
        let withdrawal_niso_boomlet_message_3 = self
            .niso
            .call(|entity| entity.produce_withdrawal_niso_boomlet_message_3().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let withdrawal_boomlet_niso_message_3 = self
            .boomlet
            .call(|entity| entity.produce_withdrawal_boomlet_niso_message_3().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let withdrawal_niso_st_message_2 = self
            .niso
            .call(|entity| entity.produce_withdrawal_niso_st_message_2().or_err())
            .await?;
        self.st
            .call(|entity| {
                entity
        ...
        let withdrawal_st_output_2 = self
            .st
            .call(|entity| entity.produce_withdrawal_st_output_2().or_err())
            .await?;
        self.peer
            .call(|entity| {
                entity
        ...
        let withdrawal_st_input_2 = self
            .peer
            .call(|entity| entity.produce_withdrawal_st_input_2().or_err())
            .await?;
        self.st
            .call(|entity| {
                entity
        ...
        let withdrawal_st_niso_message_2 = self
            .st
            .call(|entity| entity.produce_withdrawal_st_niso_message_2().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let withdrawal_niso_boomlet_message_4 = self
            .niso
            .call(|entity| entity.produce_withdrawal_niso_boomlet_message_4().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let withdrawal_boomlet_niso_message_4 = self
            .boomlet
            .call(|entity| entity.produce_withdrawal_boomlet_niso_message_4().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let reply = self
            .niso
            .call(|entity| entity.produce_withdrawal_niso_wt_message_2().or_err())
            .await?;
    ...
    async fn handle_post_commit_phase(
        &mut self,
        message: WithdrawalWtNisoMessage2,
    ) -> NetworkedResult<()> {
        self.niso
            .call(|entity| {
                entity
        ...
        let withdrawal_niso_boomlet_message_5 = self
            .niso
            .call(|entity| entity.produce_withdrawal_niso_boomlet_message_5().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let withdrawal_boomlet_niso_message_5 = self
            .boomlet
            .call(|entity| entity.produce_withdrawal_boomlet_niso_message_5().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let reply = self
            .niso
            .call(|entity| entity.produce_withdrawal_niso_wt_message_3().or_err())
            .await?;
    ...
    async fn run_ping_pong_loop(&mut self) -> NetworkedResult<()> {
            ...
            match self.recv_from_wt().await? {
                WtToPeerEnvelope::WithdrawalWtNisoMessage3(message) => {
                    ...
                    let withdrawal_niso_boomlet_message_6 = self
                        .niso
                        .call(|entity| entity.produce_withdrawal_niso_boomlet_message_6().or_err())
                        .await?;
                    self.boomlet
                        .call(|entity| {
                            entity
                        ...
                        .await?
                    {
                        ...
                        let withdrawal_niso_st_message_3 = self
                            .niso
                            .call(|entity| entity.produce_withdrawal_niso_st_message_3().or_err())
                            .await?;
                        self.st
                            .call(|entity| {
                                entity
                        ...
                        let withdrawal_st_output_3 = self
                            .st
                            .call(|entity| entity.produce_withdrawal_st_output_3().or_err())
                            .await?;
                        self.peer
                            .call(|entity| {
                                entity
                        ...
                        let withdrawal_st_input_3 = self
                            .peer
                            .call(|entity| entity.produce_withdrawal_st_input_3().or_err())
                            .await?;
                        self.st
                            .call(|entity| {
                                entity
                        ...
                        let withdrawal_st_niso_message_3 = self
                            .st
                            .call(|entity| entity.produce_withdrawal_st_niso_message_3().or_err())
                            .await?;
                        self.niso
                            .call(|entity| {
                                entity
                        ...
                        let withdrawal_niso_boomlet_message_7 = self
                            .niso
                            .call(|entity| {
                                entity.produce_withdrawal_niso_boomlet_message_7().or_err()
                            })
                            .await?;
                        self.boomlet
                            .call(|entity| {
                    ...
                    let withdrawal_boomlet_niso_message_7 = self
                        .boomlet
                        .call(|entity| entity.produce_withdrawal_boomlet_niso_message_7().or_err())
                        .await?;
                    self.niso
                        .call(|entity| {
                            entity
                    ...
                    let reply = self
                        .niso
                        .call(|entity| entity.produce_withdrawal_niso_wt_message_4().or_err())
                        .await?;
                ...
                _ => return unexpected("PeerActor: unexpected WT envelope during ping-pong"),
            }
        }
        Ok(())
    }

    async fn finish_signing(&mut self) -> NetworkedResult<()> {
        let withdrawal_niso_boomlet_message_8 = self
            .niso
            .call(|entity| entity.produce_withdrawal_niso_boomlet_message_8().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let withdrawal_boomlet_niso_message_8 = self
            .boomlet
            .call(|entity| entity.produce_withdrawal_boomlet_niso_message_8().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let withdrawal_niso_output_1 = self
            .niso
            .call(|entity| entity.produce_withdrawal_niso_output_1().or_err())
            .await?;
        self.peer
            .call(|entity| {
                entity
        ...
        let withdrawal_iso_input_1 = self
            .peer
            .call(|entity| entity.produce_withdrawal_iso_input_1().or_err())
            .await?;
        self.iso
            .call(|entity| {
                entity
        ...
        let withdrawal_iso_boomlet_message_1 = self
            .iso
            .call(|entity| entity.produce_withdrawal_iso_boomlet_message_1().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let withdrawal_boomlet_iso_message_1 = self
            .boomlet
            .call(|entity| entity.produce_withdrawal_boomlet_iso_message_1().or_err())
            .await?;
        self.iso
            .call(|entity| {
                entity
        ...
        let withdrawal_iso_boomlet_message_2 = self
            .iso
            .call(|entity| entity.produce_withdrawal_iso_boomlet_message_2().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let withdrawal_boomlet_iso_message_2 = self
            .boomlet
            .call(|entity| entity.produce_withdrawal_boomlet_iso_message_2().or_err())
            .await?;
        self.iso
            .call(|entity| {
                entity
        ...
        let withdrawal_iso_output_1 = self
            .iso
            .call(|entity| entity.produce_withdrawal_iso_output_1().or_err())
            .await?;
        self.peer
            .call(|entity| {
                entity
        ...
        let withdrawal_niso_input_2 = self
            .peer
            .call(|entity| entity.produce_withdrawal_niso_input_2().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let withdrawal_niso_boomlet_message_9 = self
            .niso
            .call(|entity| entity.produce_withdrawal_niso_boomlet_message_9().or_err())
            .await?;
        self.boomlet
            .call(|entity| {
                entity
        ...
        let withdrawal_boomlet_niso_message_9 = self
            .boomlet
            .call(|entity| entity.produce_withdrawal_boomlet_niso_message_9().or_err())
            .await?;
        self.niso
            .call(|entity| {
                entity
        ...
        let signed_psbt_message = self
            .niso
            .call(|entity| entity.produce_withdrawal_niso_wt_message_5().or_err())
            .await?;
