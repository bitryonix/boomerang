...
pub fn run(
    ...
    debug_assert!(
        ...
        "Boomerang network config should be validated before setup::run"
    );
    ...
    let niso_create_params = NisoCreateParams::new(
    ...
    let mut peer_1_niso = Niso::create_with_params(niso_create_params);
    let mut peer_2_niso = Niso::create_with_params(niso_create_params);
    let mut peer_3_niso = Niso::create_with_params(niso_create_params);
    let mut peer_4_niso = Niso::create_with_params(niso_create_params);
    let mut peer_5_niso = Niso::create_with_params(niso_create_params);
    ...
    let wt_create_params = WtCreateParams::new(
        tolerance_in_blocks_from_tx_approval_by_initiator_peer_to_tx_approval_by_wt,
    ...
    let mut active_wt = Wt::create_with_params(wt_create_params);
    let mut wt_2 = Wt::create_with_params(wt_create_params);
    let mut wt_3 = Wt::create_with_params(wt_create_params);
