...
pub struct WithdrawalNonInitiatorBoomletNonInitiatorNisoMessage4 {
    duress_check_space_with_nonce_encrypted_by_boomlet_for_st: SymmetricCiphertext,
}

impl WithdrawalNonInitiatorBoomletNonInitiatorNisoMessage4 {
    pub fn new(
        duress_check_space_with_nonce_encrypted_by_boomlet_for_st: SymmetricCiphertext,
    ) -> Self {
...
impl Message for WithdrawalNonInitiatorBoomletNonInitiatorNisoMessage4 {}
