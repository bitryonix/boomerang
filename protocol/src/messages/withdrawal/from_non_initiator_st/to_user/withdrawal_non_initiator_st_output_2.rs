...
pub struct WithdrawalNonInitiatorStOutput2 {
    duress_check_space: DuressCheckSpace,
}

impl WithdrawalNonInitiatorStOutput2 {
    pub fn new(duress_check_space: DuressCheckSpace) -> Self {
        WithdrawalNonInitiatorStOutput2 { duress_check_space }
    }
...
impl Message for WithdrawalNonInitiatorStOutput2 {}
